================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Pipe プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Pipe には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Pipe アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Pipe.h
   ...
   CPipeApp アプリケーション クラスを宣言します。

Pipe.cpp
   これは、アプリケーション クラス CPipeApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Pipe.ico
   ...
   アイコンはメイン リソース ファイル Pipe.rc に含まれていま
   す。
...
PipeDlg.h, PipeDlg.cpp - ダイアログ
   これらのファイルは CPipeDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な Pipe.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   Pipe.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
